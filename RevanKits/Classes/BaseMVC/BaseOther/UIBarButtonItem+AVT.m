...
@implementation UIBarButtonItem (AVT)
...
+(UIBarButtonItem *)itemWithTarget:(id)target action:(SEL)action title:(NSString *)title {
    return [self itemWithTarget:target action:action title:title font:[UIFont systemFontOfSize:14] titleColor:nil highlightedColor:nil titleEdgeInsets:UIEdgeInsetsZero];
}
...
+(UIBarButtonItem *)revan_itemWithTarget:(id)target
                                  action:(SEL)action
                                   title:(NSString *)title
                              titleColor:(UIColor *)titleColor
                        highlightedColor:(UIColor *)highlightedColor
